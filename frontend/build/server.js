...
\r
    <link rel="shortcut icon" href="/assets/favicon-18674101.ico" />\r
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter:300,400,500,600,700" />\r
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.9.0/css/all.min.css" integrity="sha512-q3eWabyZPc1XTCmF+8/LuE1ozpg5xxn7iO89yfSOd5/oKvyqLngoNGsx8jq92Y8eXJ/IRxQbEC+FGSYxtk2oiw==" crossorigin="anonymous" referrerpolicy="no-referrer" />\r
    <!-- <script async src="https://www.googletagmanager.com/gtag/js?id=G-2XMRM9PZYN"><\/script> -->\r
    <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.3/jquery.min.js" integrity="sha512-STof4xm1wgkfm7heWqFJVn58Hm3EtS31XFaagaa8VMReCXAkQnJZ+jEy8PCC/iT18dFy95WcExNHFTqLyp72eQ==" crossorigin="anonymous" referrerpolicy="no-referrer"><\/script> -->\r
    <!-- <script type="module" src="node_modules/"><\/script> -->\r
    \r
    <script>\r
...
\r
  ...
  <script type="module" crossorigin src="/assets/index-004ba8a7.js"><\/script>
  <link rel="stylesheet" href="/assets/index-4592d839.css">
</head>\r
<body id="kt_body">\r
   \r
    <div id="root"></div>\r
...
\r
\r
    <!--Start of Tawk.to Script-->\r
    <script type="text/javascript">\r
        // var Tawk_API = Tawk_API || {};\r
\r
        //         Tawk_API.visitor = {\r
        //         name: 'sutoyocutez@gmail.com',\r
        //             email: 'sutoyocutez@gmail.com'\r
        //     };\r
        //                 Tawk_LoadStart=new Date();\r
        // (function () {\r
        //     var s1 = document.createElement("script"), s0 = document.getElementsByTagName("script")[0];\r
        //     s1.async = true;\r
        //     s1.src = 'https://embed.tawk.to/618a41db6bb0760a4941c7f4/1fk212gf8';\r
        //     s1.charset = 'UTF-8';\r
        //     s1.setAttribute('crossorigin', '*');\r
        //     s0.parentNode.insertBefore(s1, s0);\r
        // })();\r
    <\/script>\r
    <!--End of Tawk.to Script-->\r
    \r
    <script>\r
        function copyToClipboard(element) {\r
            var $temp = $("<input>");\r
            $("body").append($temp);\r
            $temp.val($.trim($(element).text())).select();\r
            document.execCommand("copy");\r
            toastr.success('Copied');\r
            $temp.remove();\r
        }\r
\r
        function changeApiKey() {\r
            $("#apiKeyDiv").LoadingOverlay("show");\r
            $.confirm({\r
                title: 'Warning!',\r
                content: 'Are you sure!',\r
                buttons: {\r
                    Yes: function () {\r
                        $.ajax({\r
                            url: "/dashboard/changeapikey",\r
                            type: "POST",\r
                        }).done(function (response) {\r
                            if (response.isSuccess) {\r
                                toastr.success('Api Key Changed');\r
                                $("#apiKeyDiv").LoadingOverlay("hide");\r
                                $("#apiKey").text(response.apiKey);\r
                                $("#apiKey").append(" <i class='fas fa-copy' title='Copy'></i>");\r
                            } else {\r
                                $("#apiKeyDiv").LoadingOverlay("hide");\r
                                toastr.error("Api Key can not changed!");\r
                            }\r
                        }).fail(function (jqXHR, textStatus) {\r
                            $("#apiKeyDiv").LoadingOverlay("hide");\r
                            toastr.error(textStatus);\r
                        });\r
                    },\r
                    No: function () {\r
                        $("#apiKeyDiv").LoadingOverlay("hide");\r
