...
<div className="w-lg-500px p-10">
    <form className="mt-4 pt-2" id="account" method="post">
		<div className="text-center mb-11">
			<h1 className="text-dark fw-bolder mb-3">Masuk</h1>
			<div className="text-gray-500 fw-semibold fs-6"></div>
		</div>
		<div className="fv-row mb-8">
            <input type="text" placeholder="Email" autoComplete="off" className="form-control bg-transparent" data-val="true" data-val-email="Isian Email e-mail salah." data-val-required="Isisn Email diperlukan." id="Input_Email" name="Input.Email"/>
            <span className="text-danger field-validation-valid" data-valmsg-for="Input.Email" data-valmsg-replace="true"></span>
		</div>
		<div className="fv-row mb-3">
            <input type="password" placeholder="Password" autoComplete="off" className="form-control bg-transparent" data-val="true" data-val-required="Isian Password diperlukan." id="Input_Password" name="Input.Password" />
